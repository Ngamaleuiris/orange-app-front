...
import NCEUsersTable from "../components/NCEUsersTable";
...
const NCEPage = () => {
  ...
  const handleCreateUser = () => {
    navigate("/create-nceuser/NCE");
  };

  const handleModifyUser = () => {
    navigate("/modify-nceuser/NCE");
  };

  const handleDeleteUser = () => {
    navigate("/delete-user/NCE");
  };

  const handleSuspendUser = () => {
    navigate("/suspend-user/NCE");
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-orange-50 to-amber-100 relative">
      ...
      <Header title="NCE ACCESS" showBackButton={true} onBackClick={() => navigate("/dashboard")} />
        ...
        <div className="max-w-5xl w-full">
          ...
          <div className="text-center mb-12 transform transition-all duration-700 ease-out hover:scale-105 relative">
            ...
            <p className="text-gray-600 text-xl max-w-2xl mx-auto relative">
              Welcome to the NCE access management platform.
            </p>
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden border border-orange-100 relative">
            ...
            <div className="p-8 relative">
              {/* Tableau de gestion des utilisateurs NCE */}
          ...
          <div className="mt-10 text-center relative">
            <p className="text-gray-500 text-sm">
              For technical support with NCE access management, please contact 
              <button 
