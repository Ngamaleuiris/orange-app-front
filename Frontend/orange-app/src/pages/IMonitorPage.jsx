...
const IMONITORPage = () => {
  ...
  const handleCreateUser = () => {
    navigate("/create-imonitoruser/IMONITOR");
  };

  const handleModifyUser = () => {
    navigate("/modify-imonitoruser/IMONITOR");
  };

  const handleDeleteUser = () => {
    navigate("/delete-user/IMONITOR");
  };

  const handleSuspendUser = () => {
    navigate("/suspend-user/IMONITOR");
  };
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-md px-6 py-4 border-b border-orange-100">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-2xl text-gray-800">IMONITOR</span>
          </div>
          <nav>
        ...
        <div className="max-w-5xl w-full">
          ...
          <div className="text-center mb-12 transform transition-all duration-700 ease-out hover:scale-105 relative">
            ...
            <p className="text-gray-600 text-xl max-w-2xl mx-auto relative">
              Welcome to the IMONITOR access management platform. Monitor, manage, and modify user access in one central location.
            </p>
          </div>
            ...
            <div className="p-8 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-xl shadow p-5 border border-red-100 relative overflow-hidden group transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px]">
                  <div className="absolute right-0 top-0 h-20 w-20 bg-gradient-to-br from-red-100 to-red-50 rounded-bl-full z-0"></div>
          ...
          <div className="mt-10 text-center relative">
            <p className="text-gray-500 text-sm">
              For technical support with IMONITOR access management, please contact 
              <a href="#" className="text-orange-600 hover:underline ml-1">IT Support</a>
            </p>
          </div>
        </div>
      </main>
